...
public class ResumeService {
    ...
    private ResumeEntity buildSeedResume() {
        ...
        entity.setProjects(List.of(
                project(
                        "个人简历网站 & Agentic RAG 知识库系统",
                        "全栈开发工程师",
                        "2026.07 - 至今",
                        "为个人技术知识库构建自然语言智能问答系统（Agentic RAG），将 70+ 篇技术笔记转化为可交互、引用可溯源的知识资产，覆盖文档管理、混合检索、Agent 智能问答、多层记忆完整链路，采用三层架构（Spring Boot 业务层 + FastAPI AI 推理层 + React 前端）。主导整体架构设计、检索质量与系统稳定性的持续优化，并建立可量化、可回归的评估体系驱动每一轮改进。",
                        List.of(
