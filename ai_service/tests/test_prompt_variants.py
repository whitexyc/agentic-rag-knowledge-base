...
class TestPromptVariantsModule:
    ...
    def test_load_variants_default_all_with_placeholders(self):
        from eval.prompt_variants import load_variants, VARIANT_BUILDERS
    ...
    def test_baseline_is_production_prompt(self):
        ...
        from eval.prompt_variants import load_variants
    ...
    def test_compute_variant_metrics(self):
        from eval.prompt_variants import compute_variant_metrics
    ...
    def test_run_variant_fixture_produces_metrics(self):
        ...
        from eval.prompt_variants import run_variant
        dataset = [
    ...
    def test_cli_parsing(self):
        ...
        from eval.prompt_variants import main as main_fn
        with mock.patch("sys.argv",
                        ["eval.prompt_variants", "--variant", "baseline,v_brief",
                         "--limit", "3", "--no-save", "--fixture"]):
            with mock.patch("eval.prompt_variants.run_variant") as mock_run:
    ...
    def test_print_comparison_output(self, capsys):
        """对比表输出包含表头与每变体行"""
        from eval.prompt_variants import print_comparison
        print_comparison([
