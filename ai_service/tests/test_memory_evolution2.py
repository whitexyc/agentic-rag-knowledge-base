...
from eval.memory_type_dataset import (
    load_memory_type_dataset, type_metrics, gate_passed,
    GATE_TYPE_ACCURACY, fixture_judge,
)
from eval.build_memory_type_dataset import build_dataset as build_type_train
from eval.build_memory_conflict_train import build_dataset as build_conflict_train
...
class TestConflictEvalBaseline:
    ...
    def test_train_dataset_balance_and_no_overlap(self):
        from eval.memory_conflict_dataset import MEMORY_CONFLICT_DATASET
    ...
    def test_contradiction_metrics_reused(self):
        from eval.memory_conflict_dataset import contradiction_metrics
