...
DATASET_PATH = EVAL_DIR / "intent_train_dataset.json"
...
class TestTrainEvalSeparation:
    ...
    def test_training_pipeline_loads_new_dataset_first(self):
        from eval.train_intent_classifier import load_training_samples
        ...
        golden = json.loads((EVAL_DIR / "golden.json").read_text(encoding="utf-8"))
    ...
    def test_eval_set_casual_realtime_zero_leak_into_training(self):
        ...
        from eval.golden_intent import INTENT_DATASET
        from eval.train_intent_classifier import load_training_samples
    ...
    def test_train_script_no_longer_reads_golden_intent(self):
        ...
        import eval.train_intent_classifier as t
