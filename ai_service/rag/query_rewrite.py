...
async def prepare(query: str, retrieve_fn) -> tuple[str, list[dict] | None, dict]:
    ...
    fidelity = await fidelity_check(query, rewritten)
...
async def prepare_query(query: str) -> tuple[str, dict]:
