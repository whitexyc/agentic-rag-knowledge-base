...
用法（在 ai_service 目录下）:
    python -m eval.benchmark_rerank                       # 默认 500 字符、2 pair
    python -m eval.benchmark_rerank --max-chars 250       # 250 字符截断
    python -m eval.benchmark_rerank --pairs 6             # 2 pair 之外再加 6 pair
    python -m eval.benchmark_rerank --max-chars 1000 --pairs 6
