...
用法（在 ai_service 目录下）:
    python -m eval.compare_factcheck_models            # 全量 100 条真实对比
    python -m eval.compare_factcheck_models --limit 10  # 快速冒烟（验证管线）
    python -m eval.compare_factcheck_models --skip-hhem / --skip-minicheck  # 单侧
